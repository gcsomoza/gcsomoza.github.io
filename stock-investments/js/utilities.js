function calculateBuyingFee(buyingAmount) {
  ...
  const pseTransFeePercent = 0.005;
  ...
  const pseTransFee = parseFloat((buyingAmount * (pseTransFeePercent / 100)).toFixed(2))
  ...
  const fee = parseFloat((securitiesClearingCorporationFee + pseTransFee + brokerCommision + valueAddedTax).toFixed(2))
...
function calculateSellingFee(sellingAmount) {
  ...
  const pseTransFee = parseFloat((sellingAmount * (pseTransFeePercent / 100)).toFixed(2))
  ...
  const fee = parseFloat((securitiesClearingCorporationFee + pseTransFee + brokerCommision + valueAddedTax + salesTax).toFixed(2))
